...
Before long, the itinerary has tripled, and Ms. Bumbleflower needs an entire team to keep it running. [Kwain](https://scryfall.com/card/cmr/284) handles the logistics, [Nils](https://scryfall.com/card/soc/158) keeps the schedule airtight, and [Selvala](https://scryfall.com/card/cn2/70/selvala-explorer-returned) leads the ever-expanding tours. A [Generous Patron](https://scryfall.com/card/bbd/70) quietly covers today’s tab—for now. [Teferi's Tutelage](https://scryfall.com/card/m21/78) refuses to let the schedule slip by so much as a minute, and *[Bruvac the Grandiloquent](https://scryfall.com/card/rvr/35)*, the officiant, delivers the same [Gaea’s Blessing](https://scryfall.com/card/dom/161) for the eighteenth time, only louder, while Ms. Bumbleflower accepts her **[Wedding Ring](https://scryfall.com/card/who/1059)** *again*—nobody has the heart to ask which number this one is.

[Winds of Abandon](https://scryfall.com/card/mh1/37) carry them from vows beneath the [Riverchurn Monument](https://scryfall.com/card/dft/57)—home of the [Mystic Remora](https://scryfall.com/card/ice/87/mystic-remora)—to a candlelit reception in a [Sterling Grove](https://scryfall.com/card/mh2/293), and on to the *[Consecrated Sphinx](https://scryfall.com/card/sld/165)* to hear its [Tutelage](https://scryfall.com/card/ori/76). Each stop leaves everybunny more dazzled than the last. Champagne pours from the [Font of Mythos](https://scryfall.com/card/con/136), the [Temple Bell](https://scryfall.com/card/c16/277) rings, and the [Rites of Flourishing](https://scryfall.com/card/blc/122) never seem to end. Every toast to their [Prosperity](https://scryfall.com/card/c13/54) comes to swift [Forced Fruition](https://scryfall.com/card/lrw/66), each fresh whim added to the [Folio of Fancies](https://scryfall.com/card/eld/46), the [Horn of Greed](https://scryfall.com/card/cmm/385/horn-of-greed) passed around for one more round, and the [Merchant Scroll](https://scryfall.com/card/hml/33) of expenses grows longer than the last. Yet none of it comes free: a **[Smothering Tithe](https://scryfall.com/card/2x2/342)** quietly drains their accounts, one destination at a time—not even a [Windfall](https://scryfall.com/card/otc/123) can keep up.

Undeterred, Ms. Bumbleflower simply restocks. [Reliquary Tower](https://scryfall.com/card/soc/398) warehouses the presents—including a [Teferi’s Puzzle Box](https://scryfall.com/card/10e/340/teferis-puzzle-box) nobody has worked up the nerve to open—and one well-timed [Replenish](https://scryfall.com/card/uds/15) refills the pantry before anyone notices it was ever empty. One sip from the [Elixir of Immortality](https://scryfall.com/card/c21/243) leaves her refreshed, radiant, and ready to renew the vows.

She may be thriving, but the guests are not so lucky. They lose track of the days entirely, while the bells, speeches, and travel announcements become a [Maddening Cacophony](https://scryfall.com/card/znr/67). As [Psychic Corrosion](https://scryfall.com/card/m19/68) sets in, a [Psychic Spiral](https://scryfall.com/card/rtr/47) carries away where they’ve been, what they agreed to, and how many pages remain in their checkbooks.
...
Their [Fraying Sanity](https://scryfall.com/card/hou/35) shows in the stained-glass window above the altar, where *[Jace](https://scryfall.com/card/sld/506/jace-wielder-of-mysteries)* and *[Teferi](https://scryfall.com/card/sld/526)* watch the [Approach of the Second Sun](https://scryfall.com/card/akh/4/approach-of-the-second-sun), both wearing the expression of someone who already knows they’ll be doing this again tomorrow. It’s enough to [Traumatize](https://scryfall.com/card/m14/77) even the hardiest guest—not that anyone is warm enough left to lift a paw in protest. There simply isn’t anything left. All they can muster is a rueful [Swan Song](https://scryfall.com/card/c16/98).
